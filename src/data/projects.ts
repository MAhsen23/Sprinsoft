...
const projects = [
    {
        ...
        description: 'Developed a React Native mobile app, integrated with SQL Server and Python (Flask) for live visitor tracking via cameras, enhancing organizational security and monitoring capabilities.',
